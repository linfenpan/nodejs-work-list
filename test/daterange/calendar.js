// from https://github.com/webislife/jQueryDatePicker
'use strict';
    ...
    var DatePicker = function () {
        ...
        _createClass(DatePicker, [{
            ...
            value: function renderCalendar(date) {
                ...
                // html += '<div class="dt__calendar_head_wday">' + date.format('dddd') + '</div>';
                // html += '<div class="dt__calendar_head_month"><i class="prev"><</i><span>' + date.format('MMMM') + '</span><i class="next">></i></div>';
                html += '<div class="dt__calendar_head_month"><i class="prev">&lt;</i><span>' + selectDate.format('MMMM YYYY') + '</span><i class="next">&gt;</i></div>';
                // html += '<div class="dt__calendar_head_day">' + date.format('DD') + '</div>';
                // html += '<div class="dt__calendar_head_year"><i class="prev"><</i><span>' + date.format('Y') + '</span><i class="next">></i></div>';
                html += '</div>';
